...
public class CreateRoomDisplay extends Application {
    ...
    public void start(Stage primaryStage) throws IOException{
        ...
        URL xmlUrl = getClass().getResource("/createRoom.fxml");
    ...
    public static void setCurrentScene(String newSceneName){
        try{
            Parent parent = FXMLLoader.load(CreateRoomDisplay.class.getResource(newSceneName));
            Scene newScene = new Scene(parent);

            currentStage.setScene((newScene));
            CreateRoomDisplay.currentScene = newScene;
